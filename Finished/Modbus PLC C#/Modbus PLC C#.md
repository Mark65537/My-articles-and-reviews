...
>[!NOTE]
Если в качестве сервера используется программа [Modbus_Slave](https://www.modbustools.com/), чтение регистров приходится начинать с 10-го адреса — это практическая особенность используемого инструмента или его реализации протокола.
...
11. [Modbus TCP on C# with a Codesys controller](https://www.youtube.com/watch?v=ADSKdfh-3ss)
