...
Для начала нам понадобиться код инициализации. Код инициализации это код на ассемблере z80, Который передается через процессор M68000 в z80 RAM как скомпилированный массив данных. Чтобы его получить вы можете скомпилировать файл [z80\_play\_dac.asm](https://github.com/mikeakohn/java_grinder/blob/master/samples/sega_genesis/z80_play_dac.asm) с помощью `naked_asm`, перевести его в java байт массив и выделить из него код инициализации, или можете использовать готовый массив кода инициализации:  
