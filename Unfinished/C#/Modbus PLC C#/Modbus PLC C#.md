...
В этой статье я описываю реальный подход, который использовал для чтения и записи переменных из ПЛК (CODESYS + Modbus TCP) и отображения их в приложении на C#.
